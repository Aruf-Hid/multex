...
/*TimeAgo by Aruf*/
const timeAgo=(e,t)=>{let n=[6e4,36e5,864e5,6048e5,26298e5,315576e5],o=xAR.msg.timeLang.length>0?xAR.msg.timeLang:[["minute","hour","day","week","month","year"],["seconds","minutes","hours","days","weeks","months","years"],"right now","about ","about a "," ago","Today at "," AM"," PM"],g=Date.now()-e;if(g<6e4){let e=parseInt(g/1e3);return e<2?o[2]:e+" "+o[1][0]+o[5]}let r=new Date,a=new Date(e);if(null!=t&&r.getDate()==a.getDate()&&g<=n[2]){let e=e=>1==e.toString().length?"0"+e.toString():e,t=()=>a.getHours()>11?o[8]:o[7];return o[6]+((a.getHours()-12)*(a.getHours()>12)+a.getHours()*(a.getHours()<13))+":"+e(a.getMinutes())+t()}for(let e=0;e<n.length;e++)if(n[n.length-(e+1)]-1<g){let t=Math.floor(g/(n[n.length-(e+1)]-1));return t>1?o[3]+t+" "+o[1][n.length-e]+o[5]:o[4]+o[0][n.length-(e+1)]+o[5]}};


/*@shinsenter/defer.js*/ 
!function(c,i,t){var f,o=/^data-(.+)/,u='IntersectionObserver',r=/p/.test(i.readyState),s=[],a=s.slice,d='lazied',n='load',e='pageshow',l='forEach',m='hasAttribute',h='shift';function p(e){i.head.appendChild(e)}function v(e,n){a.call(e.attributes)[l](n)}function y(e,n,t,o){return o=(o=n?i.getElementById(n):o)||i.createElement(e),n&&(o.id=n),t&&(o.onload=t),o}function b(e,n){return a.call((n||i).querySelectorAll(e))}function g(t,e){b('source',t)[l](g),v(t,function(e,n){(n=o.exec(e.name))&&(t[n[1]]=e.value)}),e&&(t.className+=' '+e),n in t&&t[n]()}function I(e){f(function(o){o=b(e||'[type=deferjs]'),function e(n,t){(n=o[h]())&&(n.parentNode.removeChild(n),(t=y(n.nodeName)).text=n.text,v(n,function(e){'type'!=e.name&&(t[e.name]=e.value)}),t.src&&!t[m]('async')?(t.onload=t.onerror=e,p(t)):(p(t),e()))}()})}(f=function(e,n){r?t(e,n):s.push(e,n)}).all=I,f.js=function(n,t,e,o){f(function(e){(e=y('SCRIPT',t,o)).src=n,p(e)},e)},f.css=function(n,t,e,o){f(function(e){(e=y('LINK',t,o)).rel='stylesheet',e.href=n,p(e)},e)},f.dom=function(e,n,t,o,i){function r(e){o&&!1===o(e)||g(e,t)}f(function(t){t=u in c&&new c[u](function(e){e[l](function(e,n){e.isIntersecting&&(n=e.target)&&(t.unobserve(n),r(n))})},i),b(e||'[data-src]')[l](function(e){e[m](d)||(e.setAttribute(d,!0),t?t.observe(e):r(e))})},n)},f.reveal=g,c.Defer=f,c.addEventListener('on'+e in c?e:n,function(){for(I();s[0];t(s[h](),s[h]()))r=1})}(this,document,setTimeout),function(e,n){e.defer=n=e.Defer,e.deferscript=n.js,e.deferstyle=n.css,e.deferimg=e.deferiframe=n.dom}(this);

Defer.dom("[data-src],[data-style]", 100, "loaded", null, {rootMargin: "1px"});
...
for(x in _arM2)ARtheme.prototype[x]=_arM2[x];
...
lcPT = "template",
lcPN = "multex",
lcDn = xAR.blg.is.Pv ? "" : "+"+window[txO1].hostname;

const xIdb=t=>xAR.blg.id==t,
...
P_aBlg = (t, i) => {
	...
	"undefined"!=typeof xAR.blg.is.Pv?0==xAR.blg.is.Pv&&(window[txO1][txO2]=txO3+window[txO1][txO2]):window[txO1][txO2]=txO3+window[txO1][txO2];
},
...
if (null != xAR.gLS("_AR_blgId")) {
	...
	let dom = xAR.blg.is.Pv ? xAR.blg.url : "/";
	ldJsx({
...
/*additional*/
null!=xAR.gLS("mode")&&("darkmode"==xAR.gLS("mode")?(thmC=xAR.blg.clrD,qSel("body").classList.add("drK")):thmC=xAR.blg.clr,thmC1.content=thmC,thmC2.content=thmC,thmC3.content=thmC);
xAR.blg.is.Id&&("listmode"===xAR.gLS("list")?qSel("#mainCont").classList.add("grD"):qSel("#mainCont").classList.remove("grD"));

function darkMode(){let e;qSel("body").classList.contains("drK")?(qSel("body").classList.remove("drK"),xAR.rLS("mode"),e=xAR.blg.clr):(qSel("body").classList.add("drK"),xAR.sLS("mode","darkmode"),e=xAR.blg.clrD),thmC1.content=e,thmC2.content=e,thmC3.content=e}
function cImgpAG(){for(let l=qSell(".ntry.pApGm .imgThm, .ntry.pJob .imgThm"),m=0;m<l.length;m++){var t=l[m].getAttribute("data-img"),i=l[m].getAttribute("data-icon"),e="";null!=t&&null!==i&&(e="listmode"!=xAR.gLS("list")?i:t,xAR.blg.is.Hm&&!xAR.blg.is.Mob&&(e=t),""!=e&&(l[m].setAttribute("src",e),l[m].setAttribute("data-src",e)))}}
...
("listmode"==xAR.gLS("list")&&xAR.blg.is.Ml||"listmode"==xAR.gLS("list")&&xAR.blg.is.Id&&!xAR.blg.is.Ml&&xAR.blg.is.Mob)&&cImgpAG();
let dF=new Date(),nF=dF.getFullYear();geId("getYear").innerHTML=nF;
/*Private Blog Notif*/1==xAR.blg.is.Pvb&&toastNotif(xAR.blg.ttl+" Blog is Private.");

/*check admin blog*/
(()=>{
	ldCss("https://www.blogger.com/dyn-css/authorization.css?targetBlogID=" + xAR.blg.id, "auth-css", ()=> {
	  let e=geId("admCk");
	  if(null != e && "block" == window.getComputedStyle(e).display){
	    ...
	    //if(xAR.pU("aruf")!="edit"){
	      ...
	      qSell(".postBody p,.postBody span").forEach((e=>{e.addEventListener("contextmenu",(e=>{allRC()}))}));
	      document.onkeydown=function(e){return(!e.ctrlKey||!e.shiftKey||e.keyCode!="I".charCodeAt(0))&&((!e.ctrlKey||e.keyCode!="U".charCodeAt(0))&&((!e.ctrlKey||e.keyCode!="S".charCodeAt(0))&&void 0))};
	    ...
	    let elPs= '<div class="psLbl">';
	      n.forEach(function(dt, idx) {
	        ...
	        const psTtl = dt.title.$t,
	            ...
	            dtUpd={date:new Date(dt.updated.$t),year:()=>dtUpd.date.getUTCFullYear(),month:()=>xAR.msg.month[dtUpd.date.getUTCMonth()],day:()=>dtUpd.date.getUTCDate()},
...
let dtTm = qSell(".dtTm");
dtTm.forEach((t => {
	let e = timeAgo(Date.parse(t.getAttribute("data-datetime")));
	null != e && (t.innerHTML = e)
}));
...
arRelatedPosts = function(e) {
  ...
  if (0 < x.length) {
    for (var M = 0; M < xNumbPs && M < x.length; M++) {
      ...
      xM = xAR.msg.month[parseInt(xDate.substring(5, 7)) - 1];
      ...
      T += '<li><a class="item' + clsPs + '" aria-label="' + psTtl+ '" href="' + psLink + '"><div class="iThmb pThmb' + clsYt + '"><div class="thmb"><div class="rPst-img" data-style="background-image: ' + psThumb + '"></div></div></div> <div class="itmTtl"><span>' + psTitle + "</span>" + psDate + appVM + appAM + "</div></a></li>"
...
window.addEventListener("scroll",(()=>{    
  ...
  null!=qSel("header.scHdi")&&(qSel(".hPgCnt>*").style.width=e+"%");

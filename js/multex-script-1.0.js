...
/*TimeAgo by Aruf*/
const timeAgo=(e,t)=>{let g=[6e4,36e5,864e5,6048e5,26298e5,315576e5],n=timeLang,r=Date.now()-e;if(r<6e4){let e=parseInt(r/1e3);return e<2?n[2]:e+" "+n[1][0]+n[5]}let l=new Date,o=new Date(e);if(null!=t&&l.getDate()==o.getDate()&&r<=g[2]){let e=e=>1==e.toString().length?"0"+e.toString():e,t=()=>o.getHours()>11?n[8]:n[7];return n[6]+((o.getHours()-12)*(o.getHours()>12)+o.getHours()*(o.getHours()<13))+":"+e(o.getMinutes())+t()}for(let e=0;e<g.length;e++)if(g[g.length-(e+1)]-1<r){let t=Math.floor(r/(g[g.length-(e+1)]-1));return t>1?n[3]+t+" "+n[1][g.length-e]+n[5]:n[4]+n[0][g.length-(e+1)]+n[5]}};

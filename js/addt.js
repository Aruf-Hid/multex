...
/*No Internet*/var n=geId("noInet");null!=n&&(window.addEventListener("offline",(function(){remCt(n,"hidden"),toastNotif("You are <b>Offline</b>")})),window.addEventListener("online",(function(){addCt(n,"hidden"),toastNotif("You are <b>Online</b>")})));
...
if(qSel(".arWG")!=null){
  if(null!=geId("comment")){if(alwCmn){if(nofCmn>0)var numCmn='data-text="'+xAR.abv(nofCmn)+'" ';else numCmn="";var htmlCmn='<label class="wbCmn" '+numCmn+'for="forComments">'+ic_chat+"</label>"}else htmlCmn="";qSel(".arWG").innerHTML+=htmlCmn}
